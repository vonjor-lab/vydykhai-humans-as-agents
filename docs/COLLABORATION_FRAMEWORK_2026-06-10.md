...
The current canonical framework is [`FRAMEWORK.md`](FRAMEWORK.md), version 1.25.0.
...
Earlier document revisions remain available through the repository history, releases, and tags.
