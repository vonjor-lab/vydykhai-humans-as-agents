...
Версия: 1.29.0 | Статус: каноническое операционное ядро
...
- Project Memory Graph v4 связывает стабильный маршрут от цели к модулям и сущностям с атомарными требованиями, решениями, уроками, обязательствами, идеями, безопасными операционными указателями, покрытием источников и актуальной документацией модулей. Совместимый v3 остается читаемым до отдельно проверенного переключения.
