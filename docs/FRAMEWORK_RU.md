...
Версия: 1.27.0 | Статус: каноническое операционное ядро
...
- Scope freshness, Accepted Baseline, принятый механизм и полный применимый Memory Brief и его связь с целью, решениями и проверками;
