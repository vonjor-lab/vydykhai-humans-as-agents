...
Version: 1.29.0 | Status: canonical operating core
...
- Project Memory Graph v4 links a stable goal-to-module entity map with atomic requirements, decisions, lessons, commitments, ideas, safe operational pointers, source coverage, and current Module Contracts. Compatible v3 remains readable until a separately proven cutover.
