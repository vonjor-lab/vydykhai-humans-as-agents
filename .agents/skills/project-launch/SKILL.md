...
- Explain the working model plainly: personal orchestrator context for organization; separate research, lab, and task contexts; task-context acceptance and merge; durable shared state.
