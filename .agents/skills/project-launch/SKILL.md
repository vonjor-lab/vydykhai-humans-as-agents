...
- Create Project State with Shared Sync, participants, orchestrator links, framework/model state, tasks, active Alignment Window, one Project Memory Graph, and the tracker projection for `now / next / blocked / done`.
